...
enum Localization {
    static let strings: [String: [String: String]] = [
        "en": [
            ...
            "No screenshots yet": "No screenshots yet",
            "Click to copy": "Click to copy",
            "Copy!": "Copy!",
            "Already Copy!": "Already Copy!",
        ...
        "ru": [
            ...
            "No screenshots yet": "Скриншотов пока нет",
            "Click to copy": "Клик для копирования",
            "Copy!": "Скопировано!",
            "Already Copy!": "Уже скопировано!",
